        ...
        <section class="home-News">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <?php $neko_post_query = new WP_Query($neko_args);
                    if ($neko_news_query->have_posts()) : ?><?php while ($neko_news_query->have_posts()) : ?>
                    <?php get_template_part('template-parts/loop', 'post'); ?> </div>
            <?php endwhile;
                                                                                                                    wp_reset_postdate(); ?> <?php endif; ?>
            </div>
