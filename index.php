            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <article class="module-Article_Item">
                        <a href="#" class="module-Article_Item_Link">
                            <div class="module-Article_Item_Img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/rainy-day-thumb.jpg"
                                    alt="" width="200" height="150" load="lazy">
                            </div>
                            <div class="module-Article_Item_Body">
                                <h3 class="module-Article_Item_Title">雨の日キャンペーン開催</h3>
                                <p>湿気で髪型も決まらないし、お出かけが億劫になる雨の日。みなさまに少しでも楽しく過ごしていただきたいという思いから、Kuroneko
                                    Hairでは雨の日キャンペーンを開催することにいたしました。 当日のご予約でもOKです、</p>
                                <ul class="module-Article_Item_Meta">
                                    <li class="module-Article_Item_Cat">キャンペーン</li>
                                    <li class="module-Article_Item_Date"><time datetime="2021-03-12">2021年3月12日</time>
                                    </li>
                                </ul>
                            </div>
                        </a>
                    ...
                    <article class="module-Article_Item">
                        <a href="#" class="module-Article_Item_Link">
                            <div class="module-Article_Item_Img">
                                <img src="./assets/img/lighthouse-thumb.jpg" alt="" width="200" height="150"
                                    load="lazy">
                            </div>
                            <div class="module-Article_Item_Body">
                                <h3 class="module-Article_Item_Title">ロケーション撮影に行きました</h3>
                                <p>こんにちは、Kuroneko Hair スタッフのサビです。
                                    先日イメージ写真の撮影を行いに行ってきました。場所は〇〇市の△△砂丘です。お天気にも恵まれ、スムーズな撮影ができました。写真もめちゃくちゃ良いものが撮れていま</p>
                                <ul class="module-Article_Item_Meta">
                                    <li class="module-Article_Item_Cat">ブログ</li>
                                    <li class="module-Article_Item_Date"><time datetime="2020-11-22">2020年11月22日</time>
                                    </li>
                                </ul>
                            </div>
                        </a>
                        ...
                        <a href="#" class="module-Article_Item_Link">
                            ...
                            <div class="module-Article_Item_Body">
                                ...
                                <ul class="module-Article_Item_Meta">
                                    ...
                                    <li class="module-Article_Item_Date"><time datetime="2020-10-23">2020年10月23日</time>
                                    </li>
                                </ul>
                            </div>
                        </a>
